...
@implementation XHViewController {
    ...
    IBOutlet XHScoreView *_scoreView;
    IBOutlet XHScoreView *_bestView;
    
    XHScene *_scene;
    
    IBOutlet XHOverlay *_overlay;
...
- (void)viewDidLoad
{
    ...
    XHScene * scene = [XHScene sceneWithSize:skView.bounds.size];
...
- (void)endGame:(BOOL)won
{
    ...
    _overlayBackground.image = [XHGridView gridImageWithOverlay];
