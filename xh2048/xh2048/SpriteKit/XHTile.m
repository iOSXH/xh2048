...
typedef void (^XHBlock)();

@implementation XHTile {
...
- (instancetype)init {
    if (self = [super init]) {
        ...
        if (GSTATE.gameType == XHGameTypeFibonacci) self.level = arc4random_uniform(100) < 40 ? 1 : 2;
