...
@interface XHDefaultTheme : NSObject <XHTheme>
@end

@implementation XHDefaultTheme
...
@interface XHVibrantTheme : NSObject <XHTheme>
@end

@implementation XHVibrantTheme
...
@interface XHJoyfulTheme : NSObject <XHTheme>
@end

@implementation XHJoyfulTheme
...
+ (Class)themeClassForType:(NSInteger)type
{
    switch (type) {
        case 1:
            return [XHVibrantTheme class];
        case 2:
            return [XHJoyfulTheme class];
        default:
            return [XHDefaultTheme class];
    }
}
